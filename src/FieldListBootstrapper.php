...
class FieldListBootstrapper extends BaseDecorator
{
    ...
    public function applyToFields($fields, $applyToThis = true)
    {
        foreach ($fields as $field) {
            if (!$this->canBootstrap($field)) {
                ...
                $this->applyToFields($field->children, false);
            }
            ...
            if ((!$field->hasData() || $field->isComposite()) && !($field instanceof FormFieldBootstrapper)) {
                ...
                if ($applyToThis) {
                    ...
                    $fields->replaceField($field->Name, FormFieldBootstrapper::create($field));
                }
            }
        }
    }
